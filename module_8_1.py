...
Результат сложения числа типа "float" будем выводить с 3-мя знаками после запятой, для этого воспользуемся
методом "format()" - ("{:.3f}".format()).
"""

def add_everything_up(a, b):
    try:
        return "{:.3f}".format((float(a+b)))
